...
const Home = () => {
    ...
    return (
        <div className='min-h-[100vh] py-5'>
            <div className='pb-5'>
                <h1 className="text-2xl font-bold text-center p-4">Welcome to RPI Leave App</h1>
            </div>
            ...
            <div className='flex justify-center items-center py-5'>
                <Link className='btn btn-outline border-2 border-green-600 text-black hover:bg-green-600 rounded-md font-bold mt-4' to={'/leaves'}>Leave Application Form</Link>
            </div>
        </div>
    );
};
