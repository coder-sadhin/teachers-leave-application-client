...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-gradient-to-r from-primary to-secondary text-primary-content">
            <div>
                ...
                Rajshahi Polytechnic Institute, Rajshahi. <br/>Providing reliable tech since 1966
                </p> 
