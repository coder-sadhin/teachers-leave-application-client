        ...
        <section className='container mx-auto my-12'>
            <div className='py-12 justify-center flex items-center'>
                <div className='bg-slate-200 p-5 border rounded-xl w-9/12 md:w-1/2 lg:w-4/12 mx-auto'>
                    ...
                    <p className='font-bold text-center mt-4 hidden md:block'>New to our Site? <Link to='/register' className='link link-hover text-red-600'>Create New Account</Link></p>
                    <p className='font-bold text-center mt-4 md:hidden'>New to our Site? <Link to='/register' className='link link-hover text-red-600'>Sign Up</Link></p>
                    <div className="divider my-8"><span className='font-bold'>OR</span></div>
                    <div><button  className='btn btn-outline text-black font-bold w-full'>Continue with Google</button></div>
                </div>
            </div>
        </section>
    );
