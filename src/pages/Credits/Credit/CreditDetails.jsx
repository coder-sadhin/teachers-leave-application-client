            ...
            <div className="w-11/12 md:w-10/12  mx-auto py-12">
                <div className=" px-4 pt-3 text-center">
                    ...
                    <div className="card-actions justify-center pb-4">
                        <Link to="/credits" className="btn btn-outline border-2 hover:bg-white hover:text-black rounded-xl w-full md:w-1/2"><span className='font-bold'>Go back</span></Link>
                    </div>
                </div>
            </div>
        </section>
