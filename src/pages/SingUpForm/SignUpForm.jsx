                ...
                <div className='bg-slate-200 p-5 border rounded-xl w-9/12 md:w-1/2 lg:w-4/12 mx-auto'>
                    <form onSubmit={handleSubmit(handleSignUP)} className='grid grid-cols-1 py-8 gap-1'>
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" {...register("name", { required: "Name is required"})} placeholder="your name" className="bg-slate-100 input input-bordered" />
                            ...
                            <input type="email" {...register("email", { required: "Email Address is required"})} placeholder="email address" className="bg-slate-100 input input-bordered" />
                        ...
                        <div className="form-control">
                            ...
                            <input type="password" {...register("password", { required: "Password is required"})} placeholder="password" className="bg-slate-100 input input-bordered" />
                            {errors.password && <p role="alert" className='text-red-600'>{errors.password?.message}</p>}
                        </div>
                        <input className='btn btn-outline text-black font-bold mt-4' type="submit" value="Sign Up" />
                    </form>
